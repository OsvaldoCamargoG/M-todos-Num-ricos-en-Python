...
if RoC == True:
    ...
    plt.quiver([0], [0], solucion.real, solucion.imag, color='red', angles='xy', scale_units='xy',scale=1)
    plt.scatter(solucion.real, solucion.imag,  color='red', edgecolor='black', s=100, zorder=5, label=f'Aproximacion: {solucion}')
